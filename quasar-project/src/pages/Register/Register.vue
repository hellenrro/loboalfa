<template>
  <div>
    <div v-if="loading" class="loading " style="display: flex;justify-content: center; align-content: center; align-items: center">
      <q-spinner-facebook color="blue-10" style="justify-content: center; align-content: center; align-items: center" size="10em"></q-spinner-facebook>
    </div>
