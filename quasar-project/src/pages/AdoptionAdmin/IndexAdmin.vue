  ...
  <div v-else>
    ...
    <div class="body-area">
      <div class="cards-area" style="margin-right: 2.45rem">
        <CardGenericListAdmin v-for="item in data" :key="item.id" :name="item.name" :color="item.color"
...
<script lang="ts">
import CardGenericListAdmin from '../../components/CardGenericListAdmin.vue';
import { Ref, defineComponent, ref } from 'vue';
import axios from 'axios';
import { Notify } from 'quasar';

export default defineComponent({
  components: { CardGenericListAdmin },
  name: 'IndexAdminPage',
  setup() {
    interface Idata {
      name: string,
